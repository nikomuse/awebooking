...
/* harmony import */ var react_dates_lib_utils_isSameDay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/react-dates/lib/utils/isSameDay.js");
/* harmony import */ var react_dates_lib_utils_isSameDay__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_dates_lib_utils_isSameDay__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var react_dates_lib_utils_toMomentObject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./node_modules/react-dates/lib/utils/toMomentObject.js");
/* harmony import */ var react_dates_lib_utils_toMomentObject__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_dates_lib_utils_toMomentObject__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _utils_control__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./assets/babel/utils/control.js");
/* harmony import */ var _utils_date_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./assets/babel/utils/date-utils.js");
  ...
  _createClass(SearchForm, [{
    ...
    value: function _createDatePicker() {
      ...
      disableDates = !Array.isArray(disableDates) ? disableDates.split(/,\s?/).map(function (day) {
        return react_dates_lib_utils_toMomentObject__WEBPACK_IMPORTED_MODULE_3___default()(day);
      }) : disableDates;
      ...
      var isDayBlocked = function isDayBlocked(day) {
        ...
        if (!disabled && disableDates.length > 0) {
          disabled = disableDates.some(function (test) {
            return react_dates_lib_utils_isSameDay__WEBPACK_IMPORTED_MODULE_2___default()(day, test);
          });
        }
      ...
      var options = Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__["applyFilters"])('awebookingCreateReactDatePickerArgs', {
    ...
    value: function _registerBindings() {
      ...
      var binding = function binding(bind) {
        return function (value) {
          _this.elements[bind].set(value ? Object(_utils_date_utils__WEBPACK_IMPORTED_MODULE_5__["formatDateString"])(value) : '');
        };
      };
    ...
    value: function linkElements() {
      ...
      nodes.each(function (index, element) {
        ...
        control.elements[index] = new _utils_control__WEBPACK_IMPORTED_MODULE_4__["default"](node);
      });
    }
  }]);
...
var SearchFormModel = /*#__PURE__*/function () {
...
var OldSearchForm = /*#__PURE__*/function () {
